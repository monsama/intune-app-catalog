...
$Global:App.AppVersion = "1.4.8"   # bump when shipping a meaningfully different build, so "which version are you on" is answerable at a glance rather than by diffing the whole file
...
$toolbarTips.SetToolTip($btnFavoriteGroups, "Pick which groups and users show up as ready-to-tick options in every app's Required/Available/Uninstall lists.")
